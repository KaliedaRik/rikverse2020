...
<a href="https://twitter.com/intent/tweet?text={encodeURIComponent(`${$metaTitle} - ${$metaDescription}`)}&url={encodeURIComponent(window.location.href)}" title="Share with Twitter Followers">
    <svg viewBox="-13 -15 44 44" enable-background="new 0 0 44 44" width="44px" height="44px" aria-hidden="true" focusable="false">
        <g>
            <path d={dPath}></path>
        </g>
    </svg>
...
<a href="/cookies" title="Share with Twitter Followers">
    <svg viewBox="-13 -15 44 44" enable-background="new 0 0 44 44" width="44px" height="44px" aria-hidden="true" focusable="false">
        <g>
            <path d={dPath}></path>
        </g>
